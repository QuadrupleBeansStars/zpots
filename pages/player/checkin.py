...
def render():
    ...
    <p style="font-size:15px; color:#3d4455; max-width:500px;">Your court is reserved and the AI has prepped the surface. Just scan and start.</p>
    ...
    with left_col:
        ...
        <div class="zpots-card-surface" style="margin-top:1rem; display:flex; align-items:center; gap:12px;">
            ...
            <div>
                <div style="font-family:'Lexend'; font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:#3d4455;">INSTRUCTIONS</div>
    ...
    with right_col:
        ...
        st.markdown(f"""
            ...
            <div style="font-size:12px; color:#3d4455;">Valid for next 15 minutes</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with info_cols[0]:
        ...
        <div class="zpots-card" style="text-align:center;">
            <div style="font-family:'Lexend'; font-size:9px; text-transform:uppercase; letter-spacing:0.1em; color:#3d4455;">VENUE</div>
            <div style="font-family:'Inter'; font-weight:600; font-size:14px; margin-top:4px;">{booking['court_name']}</div>
            <div style="font-size:12px; color:#3d4455;">Court {booking['court_number']} • {booking['surface']}</div>
        </div>
        """, unsafe_allow_html=True)
    with info_cols[1]:
        st.markdown(f"""
        <div class="zpots-card" style="text-align:center;">
            <div style="font-family:'Lexend'; font-size:9px; text-transform:uppercase; letter-spacing:0.1em; color:#3d4455;">SCHEDULE</div>
            <div style="font-family:'Inter'; font-weight:600; font-size:14px; margin-top:4px;">Today, {booking['time_start']}</div>
            <div style="font-size:12px; color:#3d4455;">{booking['duration_min']} Minute Session</div>
        </div>
        """, unsafe_allow_html=True)
    with info_cols[2]:
        st.markdown("""
        <div class="zpots-card" style="text-align:center;">
            <div style="font-family:'Lexend'; font-size:9px; text-transform:uppercase; letter-spacing:0.1em; color:#3d4455;">STATUS</div>
            <div style="font-family:'Inter'; font-weight:600; font-size:14px; margin-top:4px; color:#506300;">Ready</div>
            <div style="font-size:12px; color:#3d4455;">Court is prepared</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with loc_col1:
        ...
        """, unsafe_allow_html=True)
    with loc_col2:
        st.button("📍 Get Directions", type="primary", key="get_directions", width='stretch')
