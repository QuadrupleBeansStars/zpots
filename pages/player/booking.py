...
def render():
    ...
    slot = st.session_state.get("booking_slot", {"time_start": "10:00", "time_end": "12:00", "price": 450})

    st.markdown("""
    <div style="display:flex; align-items:center; gap:8px; margin-bottom:1rem;">
        <span style="font-size:18px; cursor:pointer;">←</span>
        <span style="font-family:'Lexend'; font-size:11px; text-transform:uppercase; letter-spacing:0.1em; color:#535b71;">SECURE CHECKOUT</span>
    </div>
    ...
    with left_col:
        ...
        <div class="zpots-card-surface">
            <div style="font-family:'Lexend'; font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:#535b71; margin-bottom:8px;">SELECTED SESSION</div>
            ...
            <div style="display:flex; gap:1.5rem; margin-top:8px;">
                <span style="font-size:13px; color:#535b71;">🕐 {slot['time_start']} - {slot['time_end']}</span>
                <span style="font-size:13px; color:#535b71;">⏱ 120 Minutes</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with right_col:
        ...
        <div class="zpots-card">
            ...
            <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                <span style="font-size:14px; color:#535b71;">Base price (2 hrs)</span>
                <span style="font-family:'Inter'; font-weight:500;">฿{base_price:.2f}</span>
            </div>
            <div style="display:flex; justify-content:space-between; margin-bottom:8px; align-items:center;">
                <span style="font-size:14px; color:#535b71;">Dynamic Discount <span class="ai-tag" style="font-size:8px;">AI APPLIED</span></span>
                <span style="font-family:'Inter'; font-weight:500; color:#506300;">- ฿{discount:.2f}</span>
            </div>
            <div style="display:flex; justify-content:space-between; margin-bottom:12px;">
                <span style="font-size:14px; color:#535b71;">Service Fee</span>
                <span style="font-family:'Inter'; font-weight:500;">฿{service_fee:.2f}</span>
            </div>
            <hr>
            <div style="font-family:'Lexend'; font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:#535b71; margin-top:12px;">TOTAL AMOUNT</div>
            <div style="font-family:'Space Grotesk'; font-weight:700; font-size:2.5rem; color:#272e42;">฿{total:.2f}</div>
            <div style="font-size:11px; color:#535b71; margin-bottom:1rem;">includes taxes & fees</div>
        </div>
        """, unsafe_allow_html=True)

        if st.button("Confirm & Pay →", type="primary", use_container_width=True, key="confirm_pay"):
            st.session_state.booking_total_final = total
            navigate("booking_confirmation")

        st.markdown('<div style="text-align:center; font-size:11px; color:#535b71; margin-top:8px;">🔒 BANK-GRADE ENCRYPTED</div>', unsafe_allow_html=True)
        ...
        <div class="zpots-card-surface" style="padding:1.2rem;">
            ...
            <p style="font-size:13px; color:#535b71; font-style:italic; margin-top:8px;">"This time slot is typically quieter. You'll likely have more space for warm-ups on Court 01."</p>
        </div>
        """, unsafe_allow_html=True)
